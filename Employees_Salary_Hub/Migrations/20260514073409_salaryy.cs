...
{
    /// <inheritdoc />
    public partial class salaryy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalarySlips_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalarySlips_PayrollBatches_PayrollBatchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollBatch_Month_Year",
                table: "PayrollBatches",
                columns: new[] { "Month", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalarySlip_User_Batch",
                table: "SalarySlips",
                columns: new[] { "UserId", "PayrollBatchId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalarySlips_PayrollBatchId",
                table: "SalarySlips",
